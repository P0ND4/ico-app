...
export function getGoogleDeveloperErrorMessage(): string {
  return [
    ...
    `1. Creá un cliente OAuth "Android" con paquete ${ANDROID_PACKAGE_NAME}.`,
    '2. Agregá la huella SHA-1 (en ico-app: pnpm android:sha1; keystore: android/app/debug.keystore).',
    '3. Usá el cliente OAuth "Web" en EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID.',
